...
const Gallery = () => {
  ...
  return (
    <section id="gallery" className="section-spacing pt-1" ref={galleryRef}>
      <div className="container mx-auto px-4">
        <div className="text-center mb-3">
          <div className="mb-1 inline-block px-2 py-0.5 bg-savanna-500/10 rounded-full">
            <span className="text-xs font-medium uppercase tracking-wider text-savanna-800">Featured Works</span>
          </div>
          <h2 className="text-2xl md:text-3xl font-serif font-bold text-earth-900 mb-2">Artwork Gallery</h2>
          <p className="text-earth-700 max-w-2xl mx-auto text-sm">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
          {artworks.map((artwork, index) => (
            ...
            >
              ...
              <div className="p-2">
                <h3 className="text-lg font-medium font-serif text-earth-900 mb-1">{artwork.title}</h3>
                <div className="flex justify-between items-center text-xs text-earth-700">
