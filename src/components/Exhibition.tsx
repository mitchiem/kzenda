    ...
    <section id="exhibitions" className="section-spacing" ref={exhibitionRef}>
      <div className="container mx-auto px-6">
        <div className="text-center mb-16" ref={titleRef}>
          ...
          <h2 className="text-3xl md:text-4xl font-serif font-bold text-earth-900 mb-4">Upcoming Exhibitions</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {exhibitions.map((exhibition, index) => (
            <div 
              ...
              className="bg-white rounded-lg overflow-hidden art-shadow p-6 border border-earth-100"
            ...
            >
              ...
              <p className="text-earth-600 text-sm mb-4">{exhibition.location}</p>
              <p className="text-earth-700 mb-6 text-sm">{exhibition.description}</p>
              <Link 
                to="/exhibitions" 
